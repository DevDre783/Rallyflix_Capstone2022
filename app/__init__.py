...
from .models import db, User, Profile, List, Video
...
app.register_blueprint(video_routes, url_prefix='/api/browse')
app.register_blueprint(list_routes, url_prefix='/api/my-lists')
db.init_app(app)
Migrate(app, db)
